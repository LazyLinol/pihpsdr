...
static void filter_type_cb(GtkWidget *widget, gpointer data) { set_filter_type((uintptr_t)data); }

#ifdef SET_FILTER_SIZE
static void filter_size_cb(GtkWidget *widget, gpointer data) { set_filter_size((int)data); }
#endif
