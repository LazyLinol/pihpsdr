...
static char *btn_labels[] = {"1", "2", "3", "4", "5", "6", "7", "8", "9", ".", "0", "BS", "Hz", "kHz", "MHz", "CL"};
...
#ifdef FREEDV
static void enable_freedv_cb(GtkWidget *widget, gpointer data) { set_freedv(gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(widget))); }
#endif

#ifdef PURESIGNAL
static void enable_ps_cb(GtkWidget *widget, gpointer data) { tx_set_ps(transmitter, gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(widget))); }
#endif
