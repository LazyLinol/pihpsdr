...
static void freedv_text_changed_cb(GtkWidget *widget, gpointer data) { strcpy(transmitter->freedv_text_data, gtk_entry_get_text(GTK_ENTRY(widget))); }

static void enable_cb(GtkWidget *widget, gpointer data) { set_freedv(gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(widget))); }

static void sq_enable_cb(GtkWidget *widget, gpointer data) { freedv_set_sq_enable(gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(widget))); }

static void sq_spin_cb(GtkWidget *widget, gpointer data) { freedv_set_sq_threshold(gtk_spin_button_get_value(GTK_SPIN_BUTTON(widget))); }

static void audio_spin_cb(GtkWidget *widget, gpointer data) { freedv_set_audio_gain(gtk_spin_button_get_value(GTK_SPIN_BUTTON(widget))); }
