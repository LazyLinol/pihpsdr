...
static void function_interrupt(void *args) { function_state = (mraa_gpio_read(function_context) == 0); }

static void band_interrupt(void *args) { band_state = (mraa_gpio_read(band_context) == 0); }

static void bandstack_interrupt(void *args) { bandstack_state = (mraa_gpio_read(bandstack_context) == 0); }

static void mode_interrupt(void *args) { mode_state = (mraa_gpio_read(mode_context) == 0); }

static void filter_interrupt(void *args) { filter_state = (mraa_gpio_read(filter_context) == 0); }

static void noise_interrupt(void *args) { noise_state = (mraa_gpio_read(noise_context) == 0); }

static void agc_interrupt(void *args) { agc_state = (mraa_gpio_read(agc_context) == 0); }

static void mox_interrupt(void *args) { mox_state = (mraa_gpio_read(mox_context) == 0); }

static void lock_interrupt(void *args) { lock_state = (mraa_gpio_read(lock_context) == 0); }
