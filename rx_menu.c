...
static void random_cb(GtkWidget *widget, gpointer data) { active_receiver->random = active_receiver->random == 1 ? 0 : 1; }
...
static void sample_rate_cb(GtkWidget *widget, gpointer data) { receiver_change_sample_rate(active_receiver, (uintptr_t)data); }

static void adc_cb(GtkWidget *widget, gpointer data) { receiver_change_adc(active_receiver, (uintptr_t)data); }
...
static void mute_audio_cb(GtkWidget *widget, gpointer data) { active_receiver->mute_when_not_active = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(widget)); }

static void mute_radio_cb(GtkWidget *widget, gpointer data) { active_receiver->mute_radio = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(widget)); }
...
void rx_menu(GtkWidget *parent) {
  ...
  if (n_output_devices > 0) {
    ...
    if (active_receiver->audio_device == -1)
      active_receiver->audio_device = 0;
