...
static gboolean rit_timer_cb(gpointer data) {
  ...
  if (vfo[active_receiver->id].rit > 1000)
    vfo[active_receiver->id].rit = 1000;
  if (vfo[active_receiver->id].rit < -1000)
    vfo[active_receiver->id].rit = -1000;
...
void band_cb(GtkWidget *widget, gpointer data) { start_band(); }

void bandstack_cb(GtkWidget *widget, gpointer data) { start_bandstack(); }

void mode_cb(GtkWidget *widget, gpointer data) { start_mode(); }

void filter_cb(GtkWidget *widget, gpointer data) { start_filter(); }

void agc_cb(GtkWidget *widget, gpointer data) { start_agc(); }

void noise_cb(GtkWidget *widget, gpointer data) { start_noise(); }
...
static void atob_cb(GtkWidget *widget, gpointer data) { vfo_a_to_b(); }

static void btoa_cb(GtkWidget *widget, gpointer data) { vfo_b_to_a(); }

static void aswapb_cb(GtkWidget *widget, gpointer data) { vfo_a_swap_b(); }
...
static void freq_cb(GtkWidget *widget, gpointer data) { start_vfo(); }

static void mem_cb(GtkWidget *widget, gpointer data) { start_store(); }
...
void ptt_update(int state) { mox_update(state); }
